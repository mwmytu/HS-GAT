...
class BERTEncoder(nn.Module):
    ...
    def __init__(self, vocab_size, num_hiddens, norm_shape, ffn_num_input,
                 ...
                 max_len=50000, key_size=out_dim, query_size=out_dim, value_size=out_dim,
                 **kwargs):
...
if __name__ == '__main__':
    ...
    vocab_size, num_hiddens, ffn_num_hiddens, num_heads = 50000, out_dim, 8, 1
    ...
    # 保存bert预训练embed
    user_bert_text_df.to_csv("./word_data/user_bert_text_embed_25.csv", encoding="utf8")
    item_bert_text_df.to_csv("./word_data/item_bert_text_embed_25.csv", encoding="utf8")
