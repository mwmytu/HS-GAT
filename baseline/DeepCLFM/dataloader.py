...
def train_deal(dataset, train_data):
    ...
    if not os.path.exists("./word_data/user_words_str_30000.csv"):
        ...
        user_words_str_df.to_csv("./word_data/user_words_str_30000.csv", encoding="utf8")
    # 将每个项目的评论组合成语料库，共享语义空间
    if not os.path.exists("./word_data/item_words_str_30000.csv"):
        ...
        item_words_str_df.to_csv("./word_data/item_words_str_30000.csv", encoding="utf8")
