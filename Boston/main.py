...
for i in range(epochs):
    ...
    optimizer.zero_grad()
    # predict = model()
    predict, user_embed, item_embed = model(word_embed, u_v_matrix, v_u_matrix, ug_u_u2, ug_v_v2, u_u_dict, v_v_dict)
...
torch.save(model.state_dict(), "./model/" + str(time) + "_model_" + str(config.lr) + "_20" + ".pth")
